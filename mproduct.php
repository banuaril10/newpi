	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4>SYNC MASTER RACK FOR PRICE TAG</h4>
			</div>
			<div class="card-body">
			<div class="tables">			
				...
				<p id="notif1" style="color: red; font-weight: bold"></p>				
					...
					<table class="table table-bordered" id="example">
						...
						<?php 
						$sql_list = "select sku, name ,rack_name from inv_mproduct order by rack_name";
						$no = 1;
...
$('#butsave').on('click', function() {
	...
	$(function(){
           ...
           $('.table').DataTable({
              ...
              "serverSide": true,
              "ajax":{
                       "url": "api/action.php?modul=inventory&act=api_mproduct",
                       "dataType": "json",
                       "type": "POST"
                     },
              "columns": [
