	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<h4>SEND SALES TODAY WINDOWS</h4>
...
function SalesLine(){
	...
	$.ajax({
		url: "api/sales/action_mypos.php?modul=sales_order&act=pos_dsalesline_old&tgl1="+tgl1+"&tgl2="+tgl2,
		type: "GET",
		beforeSend: function(){
			$("#overlay").fadeIn(300);
...
function SalesHeader(){
	...
	$.ajax({
		url: "api/sales/action_mypos.php?modul=sales_order&act=pos_dsales&tgl1="+tgl1+"&tgl2="+tgl2,
		type: "GET",
		beforeSend: function(){
			$("#overlay").fadeIn(300);
			$('#notif').html("<font style='color: red'>Sedang melakukan send, mohon tunggu..</font>");
