			...
			foreach($query as $r){
				...
				if($r['status'] == 1){
					...
					if($_SESSION['name'] == 'Ka. Toko' || $_SESSION['name'] == 'Wk. Ka Toko'){
						...
						&nbsp <button type='button' class='btn btn-warning' onclick='cetakStrukDetail(\"".$r['cashinid']."\")'>Reprint </button>
						&nbsp <button type='button' class='btn btn-success' onclick='cetakStrukDetailPdf(\"".$r['cashinid']."\")'>Reprint Pdf</button>
